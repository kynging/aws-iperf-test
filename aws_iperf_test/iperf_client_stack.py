...
class IperfClient(core.Stack):
    ...
    def __init__(self, scope: core.Construct, id: str, vpc, **kwargs) -> None:
        ...
        self.iperf_client_sg = ec2.SecurityGroup(self, 'iperf-client-sg', 
                                                       vpc=vpc, 
                                                       allow_all_outbound=True,
                                                       security_group_name='iperf-client-sg')
        self.iperf_client_sg.add_ingress_rule(peer=ec2.Peer.ipv4('0.0.0.0/0'), 
                                                    connection=ec2.Port.tcp(22), 
                                                    description='Allow Inbound SSH Connection')
        self.iperf_client_sg.add_ingress_rule(peer=ec2.Peer.ipv4(cidr), 
                                                    connection=ec2.Port.all_traffic(), 
                                                    description='Allow Inbound Connection from VPC')
        security_group = self.iperf_client_sg
        ...
        role = iam.Role(self, 'iperf-client-role', 
        ...
        self.iperf_client = ec2.Instance(self, 'ec2', 
